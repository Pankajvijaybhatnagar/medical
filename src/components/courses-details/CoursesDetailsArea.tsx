                    ...
                    <div className="tab-content">
                      <div id="Course" className="tab-pane fade show active">
                        <div className="description-content">
                          <h3>Description</h3>
                          <p className="mb-3">
                            General Nursing and Midwifery (GNM) focuses on
                            equipping students with the essential skills and
                            knowledge required to provide healthcare services,
                            including nursing care, midwifery, and community
                            health support. This course ensures that students
                            gain hands-on experience in patient care, medical
                            procedures, and emergency response, preparing them
                  ...
                  <div className="courses-category-items">
                    ...
                    <ul>
                      ...
                      <li>
                        ...
                        <span className="text">15 August 2024</span>
                      </li>
                      <li>
                        {/* <span>
                        ...
                        {/* <span className="text">
                          The Heights Career Institute, Dubai
                        </span> */}
                      </li>
                      <li>
                        {/* <span>
